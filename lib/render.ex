defmodule PlugHMouse.Render do
  ...
  defp do_render_error({_content_type, error_view, template, strategy}, conn) do
  ...
  defp normalize_content_type({:ok, _type, subtype, _params}) do
